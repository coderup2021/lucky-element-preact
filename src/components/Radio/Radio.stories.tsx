...
export const DefaultRadio: Story<typeof Radio> = (args) => {
    ...
    return (
        <>
            <Radio value="1" checked={RadioValue === 1} size='lg' onChange={onChange}>主选项</Radio>
            <Radio value="2" checked={RadioValue === 2} size='mid' onChange={onChange}>备选项1</Radio>
            <Radio value="3" checked={RadioValue === 3} size='sm' disabled onChange={onChange}>备选项2</Radio>
        </>
    )
}
